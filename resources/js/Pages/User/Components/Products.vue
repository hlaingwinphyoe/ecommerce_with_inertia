<template>
        ...
        >
            ...
            >
                ...
                <a
                    ...
                    class="absolute inset-1 flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer text-white"
                >
                    <span class="bg-violet-700 rounded-full p-2 cursor-pointer">
                        <svg
    ...
    <div v-else>
        <h4 class="text-center mt-4 text-xl font-bold">There's no products.</h4>
    </div>
</template>
